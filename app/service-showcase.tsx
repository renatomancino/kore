...
const SCENE: Record<Service["id"], Scena> = {
  branding: {
    ...
    finale: (
      <Image src="/brand/kore-logo-coral.png" alt="Il marchio Kore Studio finito" width={1000} height={460} />
    ),
  },
  social: {
    etichetta: "Formati",
    ...
    finale: (
      <div className="fase-fatto-social">
        <Image src="/images/event.jpg" alt="Contenuto per un evento" fill sizes="30vw" />
      </div>
    ),
  },
  video: {
    ...
    finale: (
      <video
        ...
        playsInline
        controls
        aria-label="Esempio dimostrativo di contenuto video"
      />
    ),
  },
  web: {
  ...
  advertising: {
    ...
    finale: (
      <div className="fase-fatto-adv">
        <Image src="/images/stage.jpg" alt="Visual di una campagna" fill sizes="60vw" />
        <dl>
  ...
  eventi: {
    ...
    finale: (
      <div className="fase-fatto-eventi">
        <Image src="/images/event.jpg" alt="Un evento allestito da Kore" fill sizes="60vw" />
